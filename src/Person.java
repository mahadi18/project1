...
public class Person
{
  ...
  // line 35 "model.ump"
   public static  void main(String [] args){
    ...
    Student s2=new Student("Tom2 the student");
    Student s3=new Student("Tom3 the student");
    Student s4=new Student("Tom4 the student");
    Student s5=new Student("Tom5 the student");
